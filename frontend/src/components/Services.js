          ...
          <div className="stories-grid">
            <div className="story-card">
              <div className="story-image">
                <img src="/assets/hero-placeholder.jpg" alt="Cultural preservation project" />
              </div>
            ...
            <div className="story-card">
              <div className="story-image">
                <img src="/assets/hero-placeholder.jpg" alt="Artisan marketplace success" />
              </div>
              <div className="story-content">
            ...
            <div className="story-card">
              <div className="story-image">
                <img src="/assets/hero-placeholder.jpg" alt="Digital storytelling workshop" />
              </div>
              <div className="story-content">
